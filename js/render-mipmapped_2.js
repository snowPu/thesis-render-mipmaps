...
function changeLeftMethod() {
    lmet = document.getElementById('left-method-picker').value;
    performUpdateScene();
}
function changeRightMethod() {
    rmet = document.getElementById('right-method-picker').value;
    performUpdateScene();
}
